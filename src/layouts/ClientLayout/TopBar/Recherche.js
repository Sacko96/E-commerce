...
import { makeStyles, Button, Box, CircularProgress, InputBase, Paper, IconButton } from "@material-ui/core";
...
export default function Recherche() {
  ...
  return (
        <Paper onSubmit={e => onSubmit(e)} component="form" className={classes.search}style={{top:"0px"}} >
